...
mySreenLock      =  spawn "i3lock -i /home/ndemo/wall/flame+water.png"
...
myHK conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((altm,                 0x63),  spawn "google-chrome-stable")                    -- Alt+C
    ...
    -- Terminals
    , ((modm .|. ctrlm,     0xff0d),  spawn "terminator")                          -- Mod4+Ctrl+Return
