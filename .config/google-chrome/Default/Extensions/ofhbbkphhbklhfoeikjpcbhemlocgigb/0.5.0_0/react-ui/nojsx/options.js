...
export function AppOption({
  ...
  function renderOption() {
    switch (type) {
      ...
      case Boolean:
        {
          return React.createElement(FormGroup, null, React.createElement(Tooltip, {
            title: meta.help || ''
      ...
      default:
        return React.createElement("div", null, "Option with ", name, " (", meta.type, ") - ", appOptions.get(name));
    }
  }
